...
describe('EventRegister', () => {
  ...
  test('should throw error if event type doesn\'t exist', () => {
    ...
    expect(eventRegister.dispatch.bind(eventRegister, 'wrong-custom-event'))
      .toThrow(
        new Error(
    ...
    expect(eventRegister.remove.bind(eventRegister, {
    ...
    expect(eventRegister.removeAllListenersByType.bind(eventRegister, 'wrong-custom-event'))
      .toThrow(
        new Error(
